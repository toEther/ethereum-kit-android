    ...
    companion object {
        ...
        private fun getRouterAddress(chain: Chain) =
            when (chain) {
                ...
                Chain.Komerco -> Address("0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff")
        ...
        private fun getFactoryAddressString(chain: Chain) =
            when (chain) {
                ...
                Chain.Komerco -> "0x5757371414417b8C6CAad45bAeF941aBc7d3Ab32"
        ...
        private fun getInitCodeHashString(chain: Chain) =
            when (chain) {
                Chain.Ethereum, Chain.EthereumGoerli, Chain.Komerco, Chain.Avalanche -> "0x96e8ac4277198ff8b6f785478aa9a39f403cb768dd02cbee326c3e7da348845f"
